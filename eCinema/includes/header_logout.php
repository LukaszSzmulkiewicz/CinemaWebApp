...
<script>
  ...
  <a class="navbar-brand" href="index_signed_in.php">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul class="navbar-nav mr-auto">
        ...
        <a class="nav-link text-white" href="user_login.php">MyAccount: <?php
...
if ( !isset( $_SESSION[ 'user_id' ] ) ) { require ( 'login_tools.php' ) ; load() ; }
		...
		<span class="sr-only">(current)</span></a>
         ...
         <li class="nav-item active">
        <a class="nav-link text-white" href="index_signed_in.php">Now Showing <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-white" href="commingSoonSignedIn.php">Coming Soon</a>
      </li>
	   <li class="nav-item">
        <a class="nav-link text-white" href="snacks drinksSignedIn.php">Snacks & Drinks</a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-white" href="reviews_signedIn.php">Movie Reviews</a>
      </li>
